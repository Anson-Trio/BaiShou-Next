export const INITIAL_DIARIES = [
  {
    content: "今天去听了一场小型音乐会。那把大提琴的音色像极了秋天被阳光晒过的落叶，沉稳又温暖。虽然不认识演奏者，但那一刻我们似乎共享了某种静谧。",
    dateDaysOffset: 0,
    dateMinutesOffset: -5,
    tags: ['音乐会', '治愈', '秋天'],
    mood: 'Peaceful',
  ...
  {
    content: "在离家不远的小巷子里发现了一只三花猫。它懒洋洋地趴在长满青苔的石阶上，眯着眼冲我叫了一声。我把兜里剩下的半块饼干留给了它，它竟然蹭了蹭我的裤脚。",
    dateDaysOffset: -1,
    tags: ['小猫', '偶遇', '温暖'],
    mood: 'Happy',
  },
  {
    content: "终于去吃了那家被推荐了很多次的拉面店。热气腾腾的骨汤，劲道的面条，还有那枚恰到好处的溏心蛋。这种最简单的满足感，总是能瞬间治愈所有的疲惫。",
    dateDaysOffset: -2,
    tags: ['美食', '拉面', '满足'],
    mood: 'Content',
  },
  ...
  {
    content: "今天早起去公园散步，草尖上还挂着露珠。空气新鲜得让人想大口呼吸。我看到一位老先生在耐心地教小孙女放风筝，风筝飞得很高，像一团燃烧的火焰。",
    dateDaysOffset: -4,
    tags: ['散步', '晨曦', '希望'],
  },
  {
  ...
  {
    content: "突然很想念家乡的那碗云吞面。在那间永远冒着蒸气的小店里，承载了我多少个关于饥饿与满足的童年回忆。虽然回不去了，但那种味道一直刻在味蕾上。",
    dateDaysOffset: -6,
    tags: ['回忆', '味觉', '思念'],
  },
  {
  ...
  {
    content: "今天在书店的角落里坐了一整天。周围都是翻动书页的声音，像极了细微的蝉鸣。我读完了一个关于流浪者的故事，觉得每个人其实都在寻找自己的岛屿。",
    dateDaysOffset: -10,
    tags: ['书店', '阅读', '流浪'],
  },
  {
  ...
  {
    content: "晚霞美得令人心醉。那种层叠的紫色与橘色，在天际线交织成一场壮丽的告别。我站在天桥上注视了很久，直到夜幕像蓝色的天鹅绒般缓缓降临。",
    dateDaysOffset: -18,
    tags: ['晚霞', '瞬间', '静好'],
  },
  {
  ...
  {
    content: "整理旧衣服时，翻出了一件多年前的针织开衫。虽然已经有些起球，但穿在身上依然能感受到那种贴心的柔软。时光会磨损物件，却能加深依恋。",
    dateDaysOffset: -30,
    tags: ['旧物', '时光', '依恋'],
  },
  {
  ...
  {
    content: "今天听了一首很旧的后朋克音乐。在那略显低沉且单调的贝斯声中，我仿佛看到了自己曾经在大雨中奔跑的样子。有些伤口，其实已经变成了铠甲。",
    dateDaysOffset: -52,
    tags: ['音乐', '回忆', '坚韧'],
  },
  {
  ...
  {
    content: "跨年之夜。我没有去参加热闹的派对，而是选择独自守在壁炉旁。火苗跳动着，映照着窗外的雪。我在笔记本上写下：‘新的一年，请继续温柔。’",
    dateFixed: '2025-12-31T23:59:00Z',
    tags: ['跨年', '壁炉', '祈愿'],
  },
  {
    content: "今天在地铁上看到一位年轻人，抱着一把被裹得严严实实的吉他，眼神清亮。在这个快节奏的都市里，依然有人在坚持着那些‘不实用’的梦想，真好。",
    dateDaysOffset: -75,
    tags: ['都市', '梦想', '清亮'],
  },
  {
  ...
  {
    content: "观测日志：雨依旧在下。 sector 4 的排水系统发出了低沉的轰鸣。世界在这一刻显得格外的封闭，但这种封闭也带来了一种微妙的安全感。",
    dateDaysOffset: -90,
    tags: ['雨', '封闭', '安全感'],
  },
  {
    content: "今天去湖边写生。水波在阳光下泛着粼粼的金光。我试图用画笔抓住那变幻不定的光影，虽然很难，但在这个过程中，我彻底忘记了时间的流动。",
    dateDaysOffset: -105,
    tags: ['写生', '光影', '忘我'],
  },
  {
  ...
  {
    content: "今天学会了织围巾。虽然针法有些笨拙，但看着那团毛线一点点变成温暖的织物，心里也充实了起来。冬天快来了，我也有了抵御寒冷的能力。",
    dateDaysOffset: -140,
    tags: ['编织', '冬日', '温暖'],
  },
  {
    content: "我在那个遥远的、只属于虚拟的时空里，建立了一个名为‘白守’的记忆之岛。那里只有微风和记忆，还有永不凋谢的樱花。欢迎远行的人回家。",
    dateDaysOffset: -160,
    tags: ['岛屿', '回归', '白守'],
  },
  {
    content: "所有的思绪都在向深夜汇总。我感受到了一股前所未有的静谧。如果这种平静能一直保持下去，即使世界崩塌，我也能在那份定力中找到出口。",
    dateDaysOffset: -180,
    tags: ['深夜', '平静', '守候'],
  },
  {
  ...
  {
    content: "今天尝试写了一首短歌。虽然格律还不够严谨，但那是我对这个世界最真实的倾诉。希望能借着风的翅膀，带给每一个同样孤独的灵魂一点温暖。",
    dateDaysOffset: -480,
    tags: ['创作', '短歌', '温暖'],
  },
  {
