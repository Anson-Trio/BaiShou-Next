  ...
  describe('getSyncHistory', () => {
    ...
    it('should return logs sorted by date descending', async () => {
      const logs: SyncSessionLog[] = [
        {
          sessionId: 's2', deviceId: 'dev', direction: 'full-sync',
          startedAt: '2026-05-17T11:00:00.000Z', completedAt: '2026-05-17T11:00:01.000Z',
          success: true, operations: [],
          summary: { uploaded: 0, downloaded: 0, deletedRemote: 0, deletedLocal: 0, conflicts: 0, skipped: 0 },
        },
        {
          sessionId: 's1', deviceId: 'dev', direction: 'full-sync',
          startedAt: '2026-05-17T10:00:00.000Z', completedAt: '2026-05-17T10:00:01.000Z',
          success: true, operations: [],
          summary: { uploaded: 0, downloaded: 0, deletedRemote: 0, deletedLocal: 0, conflicts: 0, skipped: 0 },
        },
      ];
