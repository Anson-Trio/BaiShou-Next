...
import { NativeSlider } from '../Slider/NativeSlider'
...
export const EmojiToolCard: React.FC<EmojiToolCardProps> = ({
  ...
  const handleProbabilityChange = (value: number) => {
    onChange({
      ...emojiConfig,
      replyProbability: Math.min(1, Math.max(0, value / 100))
    })
  }
      ...
      >
        <View style={styles.popupContent}>
          ...
          <View style={styles.popupRow}>
            <Text style={[styles.popupLabel, { color: colors.textPrimary }]}>
              {t('agent.tools.emoji_reply_probability', '回复概率')}
            </Text>
            <View style={styles.popupSliderControl}>
              <View style={styles.sliderWrap}>
                <NativeSlider
                  ...
                  onChangeEnd={handleProbabilityChange}
                  style={styles.slider}
                />
              </View>
              <Text style={[styles.popupSliderValue, { color: colors.textPrimary }]}>
                {probabilityPercent}%
              </Text>
            </View>
          </View>
          ...
          <View style={styles.emojiManageSection}>
            ...
            {(!emojiConfig.emojis || emojiConfig.emojis.length === 0) && (
              <View style={styles.emojiEmptyHint}>
