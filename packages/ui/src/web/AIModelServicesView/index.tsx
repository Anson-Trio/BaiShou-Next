...
const BASE_KNOWN_PROVIDERS_CONFIG = [
  ...
  { id: 'xiaomimimo', name: '小米 MiMo', defaultBase: 'https://api.xiaomimimo.com/v1', isSystem: true },
  { id: 'minimax', name: 'MiniMax', defaultBase: 'https://api.minimaxi.com/v1', isSystem: true },
  { id: 'zhipu', name: '智谱 AI (ZhiPu)', defaultBase: 'https://open.bigmodel.cn/api/paas/v4', isSystem: true },
  ...
  { id: 'stepfun', name: '阶跃星辰 (StepFun)', defaultBase: 'https://api.stepfun.com/v1', isSystem: true },
  { id: 'hunyuan', name: '腾讯混元 (Hunyuan)', defaultBase: 'https://api.hunyuan.cloud.tencent.com/v1', isSystem: true },
  { id: 'vertexai', name: 'Google Vertex AI', defaultBase: 'https://aiplatform.googleapis.com/v1', isSystem: true },
  { id: 'vercel', name: 'Vercel AI Gateway', defaultBase: 'https://ai-gateway.vercel.sh/v1/ai', isSystem: true },
];
...
const PROVIDER_TYPES = [
  ...
  'zhipu', 'stepfun', 'hunyuan', 'minimax', 'vertexai', 'vercel', 'xiaomimimo'
];
