    ...
    <div className={styles.container}>
      ...
      <div className={styles.cardSection}>
        ...
        <div className={styles.cardBody}>
          <label
            className={`${styles.radioListTile} ${searchConfig.webSearchEngine === 'local-bing' ? styles.radioSelected : ''}`}
          >
            <input
              type="radio"
              name="engine"
            ...
            <div className={styles.radioCustomContainer}>
              <div className={styles.radioCustomRing}>
                {searchConfig.webSearchEngine === 'local-bing' && (
          ...
          <label
            className={`${styles.radioListTile} ${searchConfig.webSearchEngine === 'local-google' ? styles.radioSelected : ''}`}
          >
            <input
              type="radio"
              name="engine"
            ...
            <div className={styles.radioCustomContainer}>
              <div className={styles.radioCustomRing}>
                {searchConfig.webSearchEngine === 'local-google' && (
                  <div className={styles.radioCustomDot} />
                )}
              </div>
            </div>
          ...
          <label
            className={`${styles.radioListTile} ${searchConfig.webSearchEngine === 'duckduckgo' ? styles.radioSelected : ''}`}
          >
            <input
              type="radio"
              name="engine"
            ...
            <div className={styles.radioCustomContainer}>
              <div className={styles.radioCustomRing}>
                {searchConfig.webSearchEngine === 'duckduckgo' && (
                  <div className={styles.radioCustomDot} />
                )}
              </div>
            </div>
          ...
          <label
            className={`${styles.radioListTile} ${searchConfig.webSearchEngine === 'tavily' ? styles.radioSelected : ''}`}
          >
            <input
              type="radio"
              name="engine"
              ...
              <div className={styles.sliderRow}>
                ...
                <div className={styles.sliderControlRow}>
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('webSearchRagMaxChunks', parseInt(e.target.value))
                    }
                    className={styles.sliderInput}
                  />
              ...
              <div className={styles.sliderRow}>
                ...
                <div className={styles.sliderControlRow}>
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('webSearchRagChunksPerSource', parseInt(e.target.value))
                    }
                    className={styles.sliderInput}
                  />
              ...
              <div className={styles.sliderRow}>
                ...
                <div className={styles.sliderControlRow}>
                  <input
                    ...
                    onChange={(e) =>
                      handleChange('webSearchPlainSnippetLength', parseInt(e.target.value))
                    }
                    className={styles.sliderInput}
                  />
                  <span className={styles.sliderValue}>
