          ...
          {editingItem ? (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div>
                ...
                >
                  {t('shortcut.label_name', '指令标识名 (展示标签)')}
                </label>
                <input
                  value={draftName}
              ...
              <div>
                ...
                >
                  {t('shortcut.command_label', '指令命令 (用于触发)')}
                </label>
                <input
                  value={draftCommand}
              ...
              <div>
                ...
                >
                  {t('shortcut.content_prompt', '实际注入内容 (Prompt)')}
                </label>
                <textarea
                  value={draftContent}
                  onChange={(e) => setDraftContent(e.target.value)}
                  placeholder={t(
                    'shortcut.content_hint',
                    '在此输入将会插入到对话框的长文本预设指令...'
                  )}
                  style={{
                    width: '100%',
                    padding: '10px 12px',
                    ...
                    <div style={{ display: 'flex', gap: 4 }}>
                      <button
                        ...
                        style={{
                          ...
                          border: '1px solid var(--border-subtle)',
                          background:
                            currentPage === 1 ? 'var(--bg-surface-high)' : 'var(--bg-surface)',
